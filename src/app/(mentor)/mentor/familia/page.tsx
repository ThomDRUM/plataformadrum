...
const MOCK_MEMBERS: Member[] = [
  { id: "1", name: "Carlos R.", initials: "CR", generation: 1, family_role: "Fundador", business_role: "CEO", parent_id: null, works_in_business: true, notes: "Liderança principal da família." },
  { id: "2", name: "Maria R.", initials: "MR", generation: 1, family_role: "Fundadora", business_role: "", parent_id: null, works_in_business: false, notes: "" },
  { id: "3", name: "Ana R.", initials: "AR", generation: 2, family_role: "Filha", business_role: "Diretora", parent_id: "1", works_in_business: true, notes: "Interesse em liderança." },
  { id: "4", name: "Bruno R.", initials: "BR", generation: 2, family_role: "Filho", business_role: "Gerente", parent_id: "1", works_in_business: true, notes: "" },
  { id: "5", name: "Carla R.", initials: "CR", generation: 2, family_role: "Filha", business_role: "", parent_id: "1", works_in_business: false, notes: "Interesse em entrar na empresa." },
  { id: "6", name: "Diego R.", initials: "DR", generation: 2, family_role: "Filho", business_role: "", parent_id: "1", works_in_business: false, notes: "" },
  { id: "7", name: "Eduardo R.", initials: "ER", generation: 2, family_role: "Filho", business_role: "", parent_id: "1", works_in_business: false, notes: "" },
  { id: "8", name: "Felipe R.", initials: "FR", generation: 2, family_role: "Filho (menor)", business_role: "", parent_id: "1", works_in_business: false, notes: "Menor de idade." },
];
...
function EditPanel({ member, allMembers, onChange, onDelete, onClose }: {
    ...
    <div className="border border-border rounded-xl p-5 space-y-4 w-72 flex-shrink-0 h-fit">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          ...
          <input
            type="number" min={1} value={member.generation}
        ...
        <div className="flex items-center gap-2">
          <input
            type="checkbox" id={`works-${member.id}`}
      ...
      <div className="flex items-center justify-between pt-1 border-t border-border">
        ...
        <button
          onClick={() => {
            if (hasChildren) {
              alert("Remova os filhos deste membro antes de excluí-lo.");
              return;
            }
            onDelete();
          }}
...
export default function FamiliaPage() {
  ...
  function addMember(parentId: string | null, generation: number) {
    ...
    setMembers(prev => [...prev, {
      id: newId, name: "Novo membro", initials: "?",
  ...
  return (
    <div className="max-w-5xl space-y-12">
        ...
        <div className="flex items-start gap-8">
              ...
              <div className="flex items-start gap-0">
                {roots.map((root, i) => (
                  <div key={root.id} className="flex items-center">
                    {i > 0 && (
                      <div className="w-10 h-px bg-border" style={{ marginBottom: "60px" }} />
                    )}
                    <TreeNode
                      member={root}
                      allMembers={members}
          ...
          {selectedMember && (
            <EditPanel
              ...
              allMembers={members}
              onChange={(patch) => updateMember(selectedMember.id, patch)}
      ...
      <section className="max-w-3xl">
        ...
        <EditableText value={history} onChange={setHistory} rows={5} placeholder="Descreva a história da família..." />
      </section>
      ...
      <section className="max-w-3xl">
        ...
        <EditableText value={mission} onChange={setMission} rows={3} placeholder="A missão da família..." />
      </section>
      ...
      <section className="max-w-3xl">
        ...
        <EditableText value={vision} onChange={setVision} rows={3} placeholder="A visão de futuro da família..." />
      </section>
      ...
      <section className="max-w-3xl">
        ...
        <EditableText value={values} onChange={setValues} rows={3} placeholder="Os valores da família..." />
      </section>
